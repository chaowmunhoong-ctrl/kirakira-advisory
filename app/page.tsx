      ...
      <section className="cta-gradient py-20 px-4 sm:px-6" style={{ position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="max-w-3xl mx-auto text-center relative reveal">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="mailto:hello@kirakiraadvisory.com" className="btn-glow inline-block px-8 py-4 rounded font-bold text-base hover:opacity-90 transition" style={{ backgroundColor: '#FFDA1A', color: '#0051BA' }}>
              Get in Touch
            </a>
            <a
